...
(embedding_test,embedding_labels_test) =  utils.tfRead('test2')
...
#First let's load meta graph and restore weights
    saver = tf.train.import_meta_graph("./15ClassModel/audio_classifier.meta")
    saver.restore(sess,tf.train.latest_checkpoint('./15ClassModel/'))
